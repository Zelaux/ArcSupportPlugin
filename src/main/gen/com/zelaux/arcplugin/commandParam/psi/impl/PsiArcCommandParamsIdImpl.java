...
public class PsiArcCommandParamsIdImpl extends ASTWrapperPsiElement implements PsiArcCommandParamsId {

  public PsiArcCommandParamsIdImpl(@NotNull ASTNode node) {
    super(node);
  }
