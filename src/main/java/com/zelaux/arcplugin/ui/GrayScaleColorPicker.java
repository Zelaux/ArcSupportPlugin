...
import com.zelaux.arcplugin.ui.picker.*;
...
public class GrayScaleColorPicker extends JPanel implements ColorListener, DocumentListener{
    ...
    private GrayScaleColorPicker.ColorPreviewComponent myPreviewComponent;
    private final GrayScaleColorPicker.ColorWheelPanel myColorWheelPanel;
    ...
    private final java.util.List<? extends ColorPickerListener> myExternalListeners;

    private GrayScaleColorPicker.RecentColorsComponent myRecentColorsComponent;
    @Nullable
    ...
    public GrayScaleColorPicker(@NotNull Disposable parent, @Nullable Color color, boolean enableOpacity) {
        this(parent, color, true, enableOpacity, Collections.emptyList(), false);
    }

    private GrayScaleColorPicker(@NotNull Disposable parent,
                                 @Nullable Color color,
                                 boolean restoreColors, boolean enableOpacity,
                                 java.util.List<? extends ColorPickerListener> listeners, boolean opacityInPercent) {
        ...
        myColorWheelPanel = new GrayScaleColorPicker.ColorWheelPanel(this, enableOpacity, opacityInPercent);
        ...
        try {
            ...
            myRecentColorsComponent = new GrayScaleColorPicker.RecentColorsComponent(new ColorListener() {
                @Override
                public void colorChanged(Color color, Object source) {
                    setColor(color, source);
                }
    ...
    private ColorPipette createPipette(@NotNull ColorListener colorListener, @NotNull Disposable parentDisposable) {
        if (ColorPipetteBase.canUseMacPipette()) {
            ColorPipette pipette = getPipetteIfAvailable(new CMacColorPipette(this, colorListener), parentDisposable);
            if (pipette != null) {
                return pipette;
            }
        }
        return getPipetteIfAvailable(new GrayScaleColorPicker.DefaultColorPipette(this, colorListener), parentDisposable);
    }
    ...
    private JTextField createColorField(boolean hex) {
        GrayScaleColorPicker.NumberDocument doc = new GrayScaleColorPicker.NumberDocument(hex);
    ...
    public void insertUpdate(DocumentEvent e) {
        update(((GrayScaleColorPicker.NumberDocument)e.getDocument()).mySrc);
    }
    ...
    public static Color showDialog(@NotNull Component parent,
                                   ...
                                   java.util.List<? extends ColorPickerListener> listeners,
                                   boolean opacityInPercent) {
        final GrayScaleColorPicker.ColorPickerDialog dialog = new GrayScaleColorPicker.ColorPickerDialog(parent, caption, preselectedColor, enableOpacity, listeners, opacityInPercent);
        dialog.show();
    ...
    public static void showColorPickerPopup(@Nullable final Project project, @Nullable Color currentColor, @NotNull final ColorListener listener, @Nullable RelativePoint location, boolean showAlpha, boolean showAlphaAsPercent) {
        ...
        java.util.List<Color> recentColors = GrayScaleColorPicker.RecentColorsComponent.getRecentColors();
        ...
        .addColorListener(new ColorListener() {
            @Override
            public void colorChanged(Color color, Object source) {
                GrayScaleColorPicker.RecentColorsComponent.saveRecentColors(GrayScaleColorPicker.RecentColorsComponent.appendColor(color, recentColors, 20));
            }
        }, false)
    ...
    private JComponent buildTopPanel(boolean enablePipette) throws ParseException {
        ...
        myPreviewComponent = new GrayScaleColorPicker.ColorPreviewComponent();
    ...
    private static final class ColorWheelPanel extends JPanel {
        private final GrayScaleColorPicker.ColorWheel myColorWheel;
        ...
        private ColorWheelPanel(ColorListener listener, boolean enableOpacity, boolean opacityInPercent) {
            ...
            myColorWheel = new GrayScaleColorPicker.ColorWheel();
        ...
        public void setColor(Color color, Object source) {
            ...
            if (myOpacityComponent != null && source instanceof GrayScaleColorPicker) {
    ...
    private static final class ColorWheel extends JComponent {
        ...
        private final java.util.List<ColorListener> myListeners = ContainerUtil.createLockFreeCopyOnWriteList();
        ...
        protected void paintComponent(Graphics g) {
            ...
            if (myImage == null) {
                myImage = createImage(new GrayScaleColorPicker.ColorWheelImageProducer(_size - BORDER_SIZE * 2, _size - BORDER_SIZE * 2, myBrightness));
    ...
    private static final class RecentColorsComponent extends JComponent {
        ...
        private java.util.List<Color> myRecentColors = new ArrayList<>();
        ...
        private RecentColorsComponent(final ColorListener listener, boolean restoreColors) {
            addMouseListener(new MouseAdapter() {
                ...
                public void mousePressed(MouseEvent e) {
                    ...
                    if (color != null) {
                        listener.colorChanged(color, GrayScaleColorPicker.RecentColorsComponent.this);
                    }
                }
            });
        ...
        public static java.util.List<Color> getRecentColors() {
            final String value = PropertiesComponent.getInstance().getValue(COLOR_CHOOSER_COLORS_KEY);
            if (value != null) {
                final java.util.List<String> colors = StringUtil.split(value, ",,,");
                ArrayList<Color> recentColors = new ArrayList<>();
                for (String color : colors) {
                    if (color.contains("-")) {
                        java.util.List<String> components = StringUtil.split(color, "-");
        ...
        private static void saveRecentColors(java.util.List<Color> recentColors) {
        ...
        private static java.util.List<Color> appendColor(Color color, java.util.List<Color> recentColors, int maxSize) {
    ...
    static class ColorPickerDialog extends DialogWrapper {
        ...
        private final java.util.List<? extends ColorPickerListener> myListeners;
        private GrayScaleColorPicker myColorPicker;
        ...
        protected JComponent createCenterPanel() {
            if (myColorPicker == null) {
                myColorPicker = new GrayScaleColorPicker(myDisposable, myPreselectedColor, true, myEnableOpacity, myListeners, myOpacityInPercent);
            }
