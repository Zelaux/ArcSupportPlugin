...
class PremultiplyAlphaApply(expression: PsiCallExpression) : ColorCallExpressionParser(expression) {
...
class InvApply(expression: PsiCallExpression) : ColorCallExpressionParser(expression) {
