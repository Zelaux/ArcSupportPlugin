...
class ColorExpParserSequence : ExpressionParserSequence<ColorExpSequenceManager> {
    ...
    val startIndex get() = list.indexOfFirst { !it.pointless }
    override val textRange: TextRange get() = list[list.size - 1].element.textRange
...
//                addComponent(ColorComponent(java.awt.Color(0, 0, 0, 0), size, size))
    ...
    private fun tabsBuilder(
        ...
        val colorExpressionParserTabs = ColorExpressionParserTabs(list[0].element.project, {})
