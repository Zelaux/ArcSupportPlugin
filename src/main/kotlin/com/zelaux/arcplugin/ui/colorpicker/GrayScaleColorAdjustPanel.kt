...
class GrayScaleColorAdjustPanel(private val model: ColorPickerModel,
                                private val pipetteProvider: ColorPipetteProvider,
                                showAlpha: Boolean = false)
    : JPanel(GridBagLayout()), ColorListener {

    private val pipetteButton by lazy {
        val colorPipetteButton = ColorPipetteButton(model, pipetteProvider.createPipette(this@GrayScaleColorAdjustPanel))
...
/*
    ...
    val hueSlider = HueSliderComponent().apply {
        ...
        addListener {
            ...
            model.setColor(newColor, this@GrayScaleColorAdjustPanel)
        }
    }*/
    ...
    val alphaSlider = AlphaSliderComponent().apply {
        ...
        addListener {
            model.setColor(Color(model.color.red, model.color.green, model.color.blue, it), this@GrayScaleColorAdjustPanel)
        }
    }
